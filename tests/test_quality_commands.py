    ...
    def test_coverage_publishes_reports_inside_its_run(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            uv.write_text(
                ...
                "'totals': {'percent_covered': 91.0, 'percent_covered_display': '91', "
                "'num_branches': 4, 'num_partial_branches': 0, 'covered_branches': 4, "
                "'missing_branches': 0, 'percent_branches_covered': 100.0}}\n"
